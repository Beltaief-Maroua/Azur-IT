    ...
    <div className={`${style.container} p-4`}>
      ...
      <main className={`${style.main} d-flex flex-column align-items-center`}>
        <p className={`${style.mainText} m-3 text-center`}>
            Plus de 10 ans d'expérience pour aider les entreprises à atteindre leurs objectifs dans le monde de la technologie .
        </p>
        <div className={`${style.statistic} text-white d-flex justify-content-center align-items-center gap-4 mt-4 mb-3`}>
            <div className={`${style.experience} d-flex flex-column justify-content-center text-center`}>
              <span > 
                <span className={`${style.experienceYears} `}>
                  10+
                </span>   ans
                </span> 
                <span className={`${style.experienceText}`}> 
                  d'expérience 
                </span>
            </div>
            <div className={`${style.separator} h2`}> | </div>
            <div className={`${style.projects} d-flex flex-column justify-content-center text-center`}>
            ...
            <div className={`${style.separator} h2`}> | </div>
            <div className={`${style.clients} d-flex flex-column justify-content-center text-center`}>
              <span className={`${style.clientCount}`}>
                80
              </span>
              <span className={`${style.clientText}`}>
                clients satisfaits
              </span>
            </div>
            <div className={`${style.separator} h2`}> | </div>
            <div className={`${style.hours} d-flex flex-column justify-content-center text-center`}>
              <span >
                <span className={`${style.hourCount}`}>
                  40
                </span>  heures 
              </span>
              <span className={`${style.hourText}`}> 
                par semaine
              </span>
            </div>
        </div>
